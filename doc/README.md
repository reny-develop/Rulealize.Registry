...
The claim ledger the policy governs exists as data — [`ledger/claim.json`](../ledger/claim.json),
...
committed anywhere because it is derived from nuget.org on every run. [The readme](../README.md)
